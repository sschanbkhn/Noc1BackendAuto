...
{
    public class Service : RepositoryBase<Model.Net_CurenAlarm>, Net_CurenAlarm.IService
    {
        ...
        public async Task<List<CurenAlarmList>> GetListAsync(int page, int pageSize, int totalLimitItems)
        {
            var query = from x in _dbContext.Net_CurenAlarm
