...
{
    public class Net_ConfigurationLogsController : ApiControllerBase<Net_ConfigurationLogs>
    {
        private readonly IServiceWrapper _service;
        private readonly ILogger<Net_ConfigurationLogsController> _logger;
        private readonly IUserProvider _userProvider;
        public Net_ConfigurationLogsController(IServiceWrapper service, IUserProvider userProvider, ILogger<Net_ConfigurationLogsController> logger) :base(service, logger)
        {
            _logger = logger;
            _service = service;
        ...
        public async Task<IActionResult> GetListAsync(int page = 1, int pageSize = 10, int totalLimitItems = 500)
        {
            try
            {
                ...
                var items = await _service.Net_ConfigurationLogs.GetListAsync(page, pageSize, totalLimitItems);
